...
buy-and-hold at retail. Study 10 (long-only quality/profitability tilt, ADR 0012) is selected and
pre-registered: the first candidate with a genuine make-money shot since Study 6 (profitability's
long leg has a positive absolute return tilt and low turnover), asking whether holding the
high-profitability portfolio beats buy-and-hold the market net of cost, on clean daily Kenneth French
data, after an adversarial fork redirected the registered low-volatility backup.
**Next step: build the Study 10 quality-tilt net-of-market gate and ship the verdict.**
...
(long-only quality/profitability tilt pivot, pre-registered, build pending).
