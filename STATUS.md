...
- 293 offline pass + 18 live `network` tests (the figure render tests run
  locally, skipif in CI); mypy strict (src + scripts, 88 source files) / ruff /
